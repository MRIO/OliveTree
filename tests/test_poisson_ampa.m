...
steadystate_time = 20; %ms
% simtime  defined as a function of last stimulation/
delta = .025;
gpu = 1;
...
p1 = [.4:.1:1]; 		% CalciumL - conductance range
p2 = [240];     	    % g_Na_a
p3 = [.12 .15]; 		% g_int
p4 = [.12:.12:.48];      	% g_h
p5 = [-38];       	% V_h
...
def_neurons.gbar_ampa_soma = ones(noneurons,1)*.15;
