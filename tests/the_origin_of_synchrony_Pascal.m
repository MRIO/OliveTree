...
vsoma = {'V_soma'};
selection = {'V_soma' 'I_cx36' 'I_CaL' 'I_CaH'};
...
% measure of phase concentration relates to center peak offsets
% 
% 
%  the stability of the offset can be explained either by an input noise correlation or by a certain electrophysiological relationship between two cells
