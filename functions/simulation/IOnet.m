...
allfields = {'V_soma', 'Sodium_h', 'Potassium_n', 'Potassium_x_s', 'Calcium_k', ...
                        ...
                        ' g_gaba_soma', 'g_ampa_dend', ' g_ampa_soma', ' g_gaba_dend', 'Ca2_soma','current', 'ou_noise' , 'CaCC_cc'};
...
if use_gpu; results.networkParameters.connectivityMatrix = sparse(gather(W)); else; results.networkParameters.connectivityMatrix = sparse(W);end
