...
% DAMOCO Toolbox, function CO_FBTRANSF1, version 02.03.14
% Fourier series based transformation 
% protophase theta --> phase phi for one oscillator.
% Use this function of you do not trust optimization or want to 
% choose the number of Fourier coefficients manually.
% Otherwise, we recommend to use CO_FBTRT
%
