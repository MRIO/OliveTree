...
title({['ampa sub' ]; ['neuron' num2str(n)] ; num2str(p{1}(n)) ; num2str(p{2}(n))})
end
...
ax7(n) = subplot(2,2,n)
ttt = [1:500]- prc_ampa_supra{2}.peaktimes(1);
waterfall(prc_ampa_supra{n}.VS)
title({['ampa supra' ]; ['neuron' num2str(n)] ; num2str(p{1}(n)) ; num2str(p{2}(n))})
