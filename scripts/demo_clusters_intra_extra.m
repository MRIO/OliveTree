...
W{1} = createW('3d_euclidean', netsize, 3, 1, 1, 1, [], nconns, [], plotconn, [1 10 .9  0], normalize);
W{2} = createW('3d_euclidean', netsize, 3, 1, 1, 1, [], nconns, [], plotconn, [1 10 .9 .05], normalize);
W{3} = createW('3d_euclidean', netsize, 3, 1, 1, 1, [], nconns, [], plotconn, [1 10 .9 .1], normalize);
