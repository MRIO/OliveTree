...
Wonecluster 		= createW('one_cluster', netsize, 3, 1, 1, 1, [], nconns, [], plotconn, [0 0 1 0], normalize);
...
% numberofmasks = 10; 
stim_interval = [250 400];
onset_of_stim = [205:5:225];
...
pert.mask     {1} =  create_input_mask(netsize, 'dist_to_center','radius',3, 'synapseprobability', synapseprobability,'plotme',1);
pert.amplitude{1} = 1;
...
if generatemovies
	for cc = 1:6
		animate_volume(simR{cc},[1:2000],1,1)
